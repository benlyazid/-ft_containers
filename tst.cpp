...
void vector_tests(void)
{
    ...
    std::cout << "\033[1;37m[-------------------- [" << std::setw(40) << std::left << " resize method " << "] --------------------]\t\t\033[0m";
    {
		...
		v1.resize(50);
		/*------------------ ft::vectors ---------------------*/
        //std::cout << "BEGIN IS " << ft_v1.alloc()::address() << std::endl;
        ft_valid_it = ft_v1.begin();
		ft_v1.resize(50);
		z3 = v1.size();
		ft_z3 = ft_v1.size();
        ...
        // std::cout << "BEGIN IS " << ft_v1.begin() << std::endl;
		for (size_t i = 0; i < v1.size(); ++i)
			s3 += v1[i];
        ...
        // std::cout << "check for resize "  << ft_v1.size() << std::endl;
        int check = 0;
        for (; ft_valid_it != ft_v1.end(); ++ft_valid_it)
        {
            ...
            //std::cout << "check for " << *ft_valid_it << std::endl;
		/*----------------------------------------------------*/
		/*
		 * test with n = 0
		 */
...
int main()
{
	...
	std::vector<std::string> v(10, "string");
	...
	ft_v.reserve(100);
	valid_it = ft_v.begin();
	v.insert(v.begin() + 2, 2, "hello");
	ft_v.insert(ft_v.begin() + 2, 2, "hello");
